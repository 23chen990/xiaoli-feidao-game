...
const rawLevels = [
  {
    ...
    // The first 20 seconds are a single readable runway: three easy cuts,
    // one high/low timing beat, then a compact cut chain before the hazard.
    sigils: [...[[205, 312, 48], [360, 443, 30], [520, 443, 30], [680, 443, 30], [840, 443, 30], [1000, 443, 30], [1160, 443, 30], [1240, 443, 30], [1400, 443, 30], [1560, 443, 30], [2250, 351, 32], [2630, 341, 32]].map(([x, y, radius], index) => sigil(`rune-${index + 1}`, x!, y!, radius, index >= 2 && index <= 8 ? 2 : 1, 4, 5, index === 0 ? 'opening-table-a' : index === 10 ? 'tower-table' : index === 11 ? 'late-table' : 'level1-runway-main')),
      sigil('level1-hazard-approach-token', 1510, 479, 24, 3, 2, 2, 'dual-bridge-face'), sigil('level1-reward-token', 2060, 242, 24, 4, 2, 2, 'level1-reward-shelf')],
    ...
    supports: [support('white-bumper', 260, 250, 120, 24), support('white-landing', 330, 580, 280, 38), support('white-branch', 2800, 280, 180, 34), support('lantern-ferry', 760, 555, 160, 30, { axis: 'x', amplitude: 78, period: 2.7, phase: 0.35 }), support('white-column', 2900, 400, 34, 180), support('dual-bridge-face', 1580, 509, 184, 12, undefined, 'dual-bridge'), support('white-recovery-shelf', 2550, 590, 420, 46), support('lift-plank', 2140, 430, 148, 28, { axis: 'y', amplitude: 88, period: 3.1, phase: 1.2 }), support('level1-reward-shelf', 2050, 280, 220, 28), support('tower-approach', 2040, 565, 160, 34), support('level1-runway-main', 1250, 500, 1900, 54), support('opening-table-a', 205, 369, 120, 18, undefined, undefined, false), support('opening-table-b', 560, 480, 120, 18, undefined, undefined, false), support('bridge-table', 1490, 407, 170, 18, undefined, undefined, false), support('lift-table', 2140, 383, 150, 18, undefined, undefined, false), support('tower-table', 2210, 392, 150, 18, undefined, undefined, false), support('late-table', 2630, 382, 150, 18, undefined, undefined, false)],
    spikes: [{ id: 'spike-high', x: 1740, y: 100, width: 80, height: 100 }, { id: 'spike-low', x: 3200, y: 690, width: 120, height: 20 }],
