...
if(!out.startsWith(`${run}/`)||out.startsWith(toolDirectory)||existsSync(out))throw new Error('Output must be a new immutable directory inside this recovery cycle, outside qa-tools');
